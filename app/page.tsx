...
const Index: React.FC = async () => {
  return (
    <div className="w-full h-screen flex justify-center items-center">
      {/* Intro Content */}
      <div className="max-w-md bg-transparent  text-pink-600 dark:text-white rounded-lg shadow-lg border border-0.5 border-gray-300 dark:border-gray-800 p-[1.25rem]">
        <div className="flex flex-col justify-center p-4 bg-inherit gap-10">
          ...
          <h1 className="text-pink-600 dark:text-white">
            Hello Solana, meet BRAND 👋
          </h1>
          <p className={` text-pink-600 dark:text-white`}>
            Explore what you can do with our {" "}
            <b>Solana dApp Scaffold</b>
          </p>
